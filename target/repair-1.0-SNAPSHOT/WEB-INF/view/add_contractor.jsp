        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <div class="col"></div>
                   <!-- /add_conractor -->
                    <form class="form-horizontal" action="/add_conractor" onsubmit="return validateForm(this)" method="post" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input type="tel" class="text-input form-control glyphicon-phone" id="phone_login" name="phone" maxlength="17"/>
                        ...
                        <div class="tile-footer">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-3">
                                    <button class="btn btn-primary" type="submit" id="btn_send"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="/contractors"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
