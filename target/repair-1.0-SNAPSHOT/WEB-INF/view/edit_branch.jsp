...
<aside class="app-sidebar">
    <div class="sidebar-box">
        <ul class="app-menu">
            <li><a class="app-menu__item active" href="<c:url value="/" />"><i
                    class="app-menu__icon fa fa-building"></i><span class="app-menu__label">Branches</span></a></li>
            <li><a class="app-menu__item " href="<c:url value="/users" />"><i
...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-plus-square"></i> Edit Branch</h1>
        </div>
                ...
                <div class="tile-body">
                    <form class="form-horizontal">
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input class="form-control" id="branchNameId" type="text" placeholder="Branch name"
                                       value="${branch.name}">
                                <input class="form-control" id="branchHiddenId" type="hidden"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input class="form-control" type="text" placeholder="city" id="cityId"
                                       value="${branch.cityName}"/>
                                <input class="form-control" type="hidden" id="city_hidden_Id" name="city_hidden_Id"
                                       value="${branch.cityId}"/>
                            </div>
                        </div>
                        <div class="form-group row" id="region"  <c:if test="${branch.regionId == 0  }"> hidden="hidden"
                        </c:if>>
                            <label class="control-label col-md-3">Region</label>
                            <div class="col-md-3 d-block">
                                <input class="form-control" type="text" id="regionId" value="${branch.regionName}"/>
                                <input class="form-control" type="hidden" id="region_hidden_Id" name="region_hidden_Id"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <textarea class="form-control" rows="4" id="addressId">${branch.address}</textarea>
                            </div>
                        </div>

                        <div class="form-group" style="margin-bottom: 0px;">
                            <div class="col-md-4 offset-8" style="padding-right: 0px;">
                                <input class="form-control col-md-8 d-inline" style="margin-left: 77px;" type="text"
                                       placeholder="users" id="userId">
                                <input class="form-control col-md-8 d-inline" style="margin-left: 77px;" type="hidden"
                                       placeholder="users" id="userIdHidden">
                                <button id="userBtnId" type="button" class="btn btn-default" style="margin-bottom: 6px">
                        ...
                        <table class="table table-hover table-bordered col-md-6" id="sampleTable">
                            ...
                            <c:forEach var="items" items="${branch.users}">
                                <c:if test="${items.userId!=0}">
                                <tr userId="${items.userId}" roleId="${items.roleId}"
                        ...
                        <div class="tile-footer">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-3">
                                    <button class="btn btn-primary" id="branchBtnId" type="button"><i
