        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    ...
                    <form class="form-horizontal" action="/add_role" method="post" id="role_form" onsubmit="return validateform()">
                        <div class="form-group row">
                            <div class="col-12">
                                <label class="control-label" style="margin-right: 43px;">Role adı: </label>
                                <input class="form-control d-inline-block col-3" type="text" placeholder="" id="role_name" name="role_name">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                ...
                                <select class="form-control d-inline-block col-3" id="combo_role2" name="create_user">
                                    <option value="own_branch" selected>Öz filalı</option>
                                    <option value="all_branch">Bütün filallar</option>
                        ...
                        <div class="form-group row">
                            <div class="custom-checkbox col-12">
                                ...
                                <input type="checkbox" name="create_branch" class="form-control d-inline-block col-1">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="custom-checkbox col-12">
                                ...
                                <input type="checkbox" name="create_order" class="form-control d-inline-block col-1">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                ...
                                <select class="form-control d-inline-block col-3" id="combo_role1" name="view_orders">
                                    <option value="own_order" selected>Özünü</option>
                                    <option value="other_order">Filaldakı əməkdaşlar</option>
                                    <option value="all_order">Bütün filaldakı əməkdaşlar</option>
                                </select>
                            </div>
                        </div>
                        <div class="tile-footer">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-3">
                                    <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="/roles"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
